...
# === Гиперпараметры ===
SEQ_LENGTH = 10
MODEL_PATH = "lstm_distance_model_Near.pth"
SCALER_X_PATH = "scaler_x_Near.pkl"
SCALER_Y_PATH = "scaler_y_Near.pkl"
...
if __name__ == "__main__":
    ...
    rssi_values, true_distances = load_data("Test_Near_Ready.txt")
